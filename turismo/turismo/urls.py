...
from turismo_salvador.api.viewsets import TurismoSalvadorViewSet
from atividades.api.viewsets import AtividadesViewSet
...
router.register(r'turismosalvador', TurismoSalvadorViewSet, basename='TurismoSalvador')
